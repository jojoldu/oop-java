...
### 코드리뷰 - 반영 (2)
이번 시간엔 역할이 모호했던 API영역과 Client 영역을 분리하겠습니다. <br/>
기존 코드에는 print out이 도메인, 비지니스 로직 곳곳에 존재 합니다. <br/>
웹 게시판 형태였다면 이런 Layer (계층) 분리가 좀 더 명확했겠지만 콘솔에서의 구현을 생각하다보니 Layer를 무시해버린것 같습니다. <br/>
